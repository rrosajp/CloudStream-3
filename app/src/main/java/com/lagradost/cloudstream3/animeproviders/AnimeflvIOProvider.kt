...
class AnimeflvIOProvider : MainAPI() {
    ...
    data class MainJson(
        ...
        @SerialName("source_bk") val sourceBk: String?,
        @SerialName("track") val track: List<String>?,
        @SerialName("advertising") val advertising: List<String>?,
        @SerialName("linkiframe") val linkiframe: String?
    )
