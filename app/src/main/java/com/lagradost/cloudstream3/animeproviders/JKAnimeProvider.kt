...
class JKAnimeProvider : MainAPI() {
    ...
    @Serializable data class MainSearch(
        @SerialName("animes") val animes: List<Animes>,
        @SerialName("anime_types") val animeTypes: AnimeTypes
    )

    @Serializable data class Animes(
    ...
    @Serializable data class AnimeTypes(
        @SerialName("TV") val TV: String,
        @SerialName("OVA") val OVA: String,
        @SerialName("Movie") val Movie: String,
        @SerialName("Special") val Special: String,
        @SerialName("ONA") val ONA: String,
    ...
    @Serializable data class Nozomi(
